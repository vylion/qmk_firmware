...
/* Base -- ASER/GYJUL
 * ,-----------------------------------------------------------------------------------.
 * | Esc  |   Q  |   W  |   D  |   F  |   G  |   Y  |   J  |   U  |   L  |  - _ | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   A  |  ⎇ S |  ⇧ E |  ^ R |   T  |   H  |  ^ N |  ⇧ I |  ⎇ O |   á  |  à   |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_QWERTY] = LAYOUT_planck_mit(
    ...
    OS_LCTL, KC_A,    ALT_S,   SHFT_E,  CTRL_R,  KC_T,    KC_H,    CTRL_N,  SHFT_I,  ALT_O,   ES_ACUT, ES_MINS,
...
/* Game -- QWERTY
 * ,-----------------------------------------------------------------------------------.
 * |      |   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  | - _  | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   á  |   à  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_GAME] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    _______, _______,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_P,    _______, _______, _______,
...
[_SYM] = LAYOUT_planck_mit(
    KC_ESC,  ES_PIPE, ES_AT,   ES_HASH, ES_TILD, ES_DLR,  ES_EUR,  ES_PERC, ES_AMPR, ES_PLUS, ES_ASTR, ES_EQL,
...
[_XTRA] = LAYOUT_planck_mit(
    ES_SLSH, KC_COMM, KC_7,    KC_8,    KC_9,    GAME,    QK_BOOT, RGB_VAI, RGB_SAI, RGB_HUI, RGB_MOD, KC_PSCR,
