...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_reviung41(
    KC_TAB,   KC_Q,     KC_W,     KC_D,     KC_F,      KC_G,               KC_Y,     KC_J,     KC_U,     KC_L,     KC_SCLN,  KC_DEL,
    KC_LCTL,  KC_A,     ALT_S,    SHFT_E,   CTRL_R,    KC_T,               KC_H,     CTRL_N,   SHFT_I,   ALT_O,    KC_UP,    ES_CCED,
    KC_LGUI,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,               KC_K,     KC_M,     KC_P,     KC_LEFT,  KC_DOWN,  KC_RIGHT,
