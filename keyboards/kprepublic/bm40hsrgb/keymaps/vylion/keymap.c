...
/* QwertyFlip
 * ,-----------------------------------------------------------------------------------.
 * | Esc  |   Q  |   W  |   D  |   F  |   G  |   Y  |   J  |   K  |   L  |   à  | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   A  |  ⎇ S |  ⇧ E |  ^ R |   T  |   H  |  ^ U |  ⇧ I |  ⎇ O |   á  | - _  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_QWERTY] = LAYOUT_planck_mit(
    KC_ESC,  KC_Q,    KC_W,    KC_D,    KC_F,    KC_G,    KC_Y,    KC_J,    KC_K,    KC_L,    ES_GRV, KC_DEL,
    KC_LCTL, KC_A,    ALT_S,   SHFT_E,  CTRL_R,  KC_T,    KC_H,    CTRL_U,  SHFT_I,  ALT_O,   ES_ACUT, ES_MINS,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_P,    ES_NTIL, KC_UP,   KC_ENT,
    KC_LGUI, LT_FN,   KC_TAB,  LEFT_XT, KC_SPC,     MO(_SYM),      KC_BSPC, RGHT_XT, KC_LEFT, KC_DOWN, KC_RGHT
),

/* Game
 * ,-----------------------------------------------------------------------------------.
 * |      |   Q  |   W  |   F  |   R  |   T  |   Y  |   J  |   K  |   L  |   à  | Del  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   A  |   S  |   D  |   F  |   G  |   H  |   U  |   I  |   O  |   á  | - _  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   P  |   Ñ  |  Up  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_GAME] = LAYOUT_planck_mit(
    _______, _______, _______, KC_E,    KC_R,    KC_T,    _______, _______, _______, _______, _______, _______,
    _______, _______, KC_S,    KC_D,    KC_F,    KC_G,    _______, KC_U,    KC_I,    KC_O,    _______, _______,
